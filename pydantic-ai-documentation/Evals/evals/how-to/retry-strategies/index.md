...
Retry configurations use [Tenacity](https://tenacity.readthedocs.io/) and support the same options as Pydantic AI's RetryConfig:
...
- **[Logfire Integration](https://ai.pydantic.dev/evals/how-to/logfire-integration/index.md)** - View retries in Logfire
