...
1. We configure the agent to use [Anthropic's Claude Sonnet 4.6](https://ai.pydantic.dev/api/models/anthropic/index.md) model, but you can also set the model when running the agent.
...
Not very interesting yet, but we can easily add [tools](https://ai.pydantic.dev/tools/index.md), [dynamic instructions](https://ai.pydantic.dev/agent/#instructions), [structured outputs](https://ai.pydantic.dev/output/index.md), or composable [capabilities](https://ai.pydantic.dev/capabilities/index.md) to build more powerful agents.
...
[Learn about Gateway](https://ai.pydantic.dev/gateway) hello_world_capabilities.py
